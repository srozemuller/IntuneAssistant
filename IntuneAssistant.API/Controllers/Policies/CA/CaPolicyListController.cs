...
public sealed class CaPolicyListController : ControllerBase
{
    ...
    private readonly ILogger<CaPolicyListController> _logger;
    private readonly ITokenAcquisition _tokenAcquisition;
    public CaPolicyListController(ILogger<CaPolicyListController> logger,
    ...
    public async Task<ActionResult> Get()
    {
        ...
        else
        {
            foreach (var policy in caPolicies)
            {
                ...
                {
                    UserModel allUser = new UserModel { DisplayName = "All Users" };
                ...
                var includedGroupsIds = policy.Conditions.Users.IncludeGroups
                    ...
                    .ToList();
                var includedGroups = await _groupInformationService.GetGroupInformationByIdsCollectionListAsync(accessToken, includedGroupsIds);
