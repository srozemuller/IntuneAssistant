...
"[project]/app/assistant/user-assignments/apps/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AssignmentsOverview() {
    ...
    // Search mode
    const [searchMode] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])('group');
    ...
    const fetchUserAssignments = async (userId)=>{
        ...
        try {
            const [assignmentsData, filtersData] = await Promise.all([
                request(`${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ASSIGNMENTS_ENDPOINT"]}/user/${userId}/apps`, {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'application/json'
                    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b3acbaa8._.js.map