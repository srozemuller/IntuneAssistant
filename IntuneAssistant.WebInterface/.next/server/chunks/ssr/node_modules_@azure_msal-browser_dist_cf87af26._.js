 ...
 */ class BrowserCacheManager extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$azure$2f$msal$2d$common$2f$dist$2f$cache$2f$CacheManager$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CacheManager"] {
     ...
     */ getAccount(accountKey, correlationId) {
        ...
        this.performanceClient.addFields({
            accountCachedBy: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$azure$2f$msal$2d$browser$2f$dist$2f$utils$2f$BrowserConstants$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiIdToName"])(parsedAccount.cachedByApiId)
        }, correlationId);
 ...
 */ async function handleResponseCode(request, response, codeVerifier, apiId, config, authClient, browserStorage, nativeStorage, eventHandler, logger, performanceClient, platformAuthProvider) {
    ...
    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$azure$2f$msal$2d$common$2f$dist$2f$utils$2f$FunctionWrappers$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["invokeAsync"])(interactionHandler.handleCodeResponse.bind(interactionHandler), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$azure$2f$msal$2d$common$2f$dist$2f$telemetry$2f$performance$2f$PerformanceEvent$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["PerformanceEvents"].HandleCodeResponse, logger, performanceClient, request.correlationId)(response, request, apiId);
    return result;
}
/**
 ...
 */ class TokenCache {
     ...
     */ async loadExternalTokens(request, response, options) {
        ...
        const rootMeasurement = this.performanceClient.startMeasurement(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$azure$2f$msal$2d$common$2f$dist$2f$telemetry$2f$performance$2f$PerformanceEvent$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["PerformanceEvents"].LoadExternalTokens, correlationId);
        try {
            ...
            const authority = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$azure$2f$msal$2d$common$2f$dist$2f$authority$2f$AuthorityFactory$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__AuthorityFactory$3e$__["AuthorityFactory"].createDiscoveredInstance(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$azure$2f$msal$2d$common$2f$dist$2f$authority$2f$Authority$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Authority"].generateAuthority(authorityString, request.azureCloudOptions), this.config.system.networkClient, this.storage, authorityOptions, this.logger, correlationId, this.performanceClient);
            const cacheRecordAccount = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$azure$2f$msal$2d$common$2f$dist$2f$utils$2f$FunctionWrappers$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["invokeAsync"])(this.loadAccount.bind(this), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$azure$2f$msal$2d$common$2f$dist$2f$telemetry$2f$performance$2f$PerformanceEvent$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["PerformanceEvents"].LoadAccount, this.logger, this.performanceClient, correlationId)(request, options.clientInfo || response.client_info || "", correlationId, authority, idTokenClaims);
            const idToken = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$azure$2f$msal$2d$common$2f$dist$2f$utils$2f$FunctionWrappers$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["invokeAsync"])(this.loadIdToken.bind(this), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$azure$2f$msal$2d$common$2f$dist$2f$telemetry$2f$performance$2f$PerformanceEvent$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["PerformanceEvents"].LoadIdToken, this.logger, this.performanceClient, correlationId)(response, cacheRecordAccount.homeAccountId, cacheRecordAccount.environment, cacheRecordAccount.realm, correlationId, kmsi);
            const accessToken = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$azure$2f$msal$2d$common$2f$dist$2f$utils$2f$FunctionWrappers$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["invokeAsync"])(this.loadAccessToken.bind(this), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$azure$2f$msal$2d$common$2f$dist$2f$telemetry$2f$performance$2f$PerformanceEvent$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["PerformanceEvents"].LoadAccessToken, this.logger, this.performanceClient, correlationId)(request, response, cacheRecordAccount.homeAccountId, cacheRecordAccount.environment, cacheRecordAccount.realm, options, correlationId, kmsi);
            const refreshToken = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$azure$2f$msal$2d$common$2f$dist$2f$utils$2f$FunctionWrappers$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["invokeAsync"])(this.loadRefreshToken.bind(this), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$azure$2f$msal$2d$common$2f$dist$2f$telemetry$2f$performance$2f$PerformanceEvent$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["PerformanceEvents"].LoadRefreshToken, this.logger, this.performanceClient, correlationId)(response, cacheRecordAccount.homeAccountId, cacheRecordAccount.environment, correlationId, kmsi);
            rootMeasurement.end({
                success: true
            }, undefined, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$azure$2f$msal$2d$common$2f$dist$2f$cache$2f$entities$2f$AccountEntity$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AccountEntity"].getAccountInfo(cacheRecordAccount));
     ...
     */ async loadAccount(request, clientInfo, correlationId, authority, idTokenClaims) {
        ...
        if (request.account) {
            ...
            await this.storage.setAccount(accountEntity, correlationId, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$azure$2f$msal$2d$common$2f$dist$2f$account$2f$AuthToken$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__AuthToken$3e$__["AuthToken"].isKmsi(idTokenClaims || {}), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$azure$2f$msal$2d$browser$2f$dist$2f$utils$2f$BrowserConstants$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ApiId"].loadExternalTokens);
...
class StandardController {
     ...
     */ constructor(operatingContext){
        ...
        this.tokenCache = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$azure$2f$msal$2d$browser$2f$dist$2f$cache$2f$TokenCache$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TokenCache"](this.config, this.browserStorage, this.logger, this.browserCrypto, this.performanceClient);
     ...
     */ async hydrateCache(result, request) {
        ...
        await this.browserStorage.setAccount(accountEntity, result.correlationId, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$azure$2f$msal$2d$common$2f$dist$2f$account$2f$AuthToken$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__AuthToken$3e$__["AuthToken"].isKmsi(result.idTokenClaims), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$azure$2f$msal$2d$browser$2f$dist$2f$utils$2f$BrowserConstants$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ApiId"].hydrateCache);
