...
"[project]/app/assistant/assignments-overview/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AssignmentsOverview() {
    ...
    const getSearchFilteredData = (data)=>{
        ...
        return data.filter((assignment)=>{
            return assignment.resourceName?.toLowerCase().includes(query) || assignment.targetName?.toLowerCase().includes(query) || assignment.assignmentType?.toLowerCase().includes(query) || assignment.resourceType?.toLowerCase().includes(query) || assignment.platform?.toLowerCase().includes(query) || getFilterInfo(assignment.filterId, assignment.filterType).displayName.toLowerCase().includes(query);
        });
    };
    ...
    const columns = [
        {
            ...
            render: (value, row)=>{
                ...
                const warningIcon = hasWarnings ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                    title: warnings.join('\n'),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__abafaafc._.js.map