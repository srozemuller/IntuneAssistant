        ...
        if (source === 'catalog' && policy.settings) {
            for (const s of policy.settings){
                rows.push({
                    ...
                    source,
                    childSettingInfo: s.childSettingInfo ?? null,
                    status: 'ok'
                });
            }
...
function markDuplicatesAndConflicts(rows) {
    ...
    return rows.map((row)=>{
        ...
        const values = new Set(siblings.map((s)=>(s.settingValue ?? '').toLowerCase()));
        return {
            ...row,
            status: values.size > 1 ? 'conflict' : 'duplicate'
        };
    });
}
const FETCH_STEPS = [
...
function PolicySettingsPage() {
    ...
    const prepareExportData = ()=>{
        ...
        return {
            ...
            stats: [
                ...
                {
                    label: 'Catalog',
                    value: settings.filter((s)=>s.source === 'catalog').length
                },
                {
                    label: 'Device Config',
                    value: settings.filter((s)=>s.source === 'deviceconfig').length
                },
                {
                    label: 'Group Policy',
                ...
                {
                    label: 'Duplicates',
                    value: settings.filter((s)=>s.status === 'duplicate').length
                },
                {
                    label: 'Conflicts',
                    value: settings.filter((s)=>s.status === 'conflict').length
                }
            ]
        };
    };
    ...
    const dupCount = settings.filter((s)=>s.status === 'duplicate').length;
    const conflictCount = settings.filter((s)=>s.status === 'conflict').length;
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            settings.length > 0 && !loading && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$badge$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Badge"], {
                        ...
                        children: [
                            settings.filter((s)=>s.source === 'catalog').length,
                            " Settings Catalog"
                        ]
                    }, void 0, true, {
                        fileName: "[project]/app/configuration/settings/page.tsx",
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$badge$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Badge"], {
                        ...
                        children: [
                            settings.filter((s)=>s.source === 'deviceconfig').length,
                            " Device Config"
                        ]
                    }, void 0, true, {
                        fileName: "[project]/app/configuration/settings/page.tsx",
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$badge$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Badge"], {
                        ...
                        children: [
                            settings.filter((s)=>s.source === 'grouppolicy').length,
                            " Group Policy"
                        ]
                    }, void 0, true, {
                        fileName: "[project]/app/configuration/settings/page.tsx",
                    ...
                    dupCount > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$badge$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Badge"], {
                        variant: "outline",
                    ...
                    conflictCount > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$badge$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Badge"], {
                        variant: "outline",
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9f4e29fa._.js.map