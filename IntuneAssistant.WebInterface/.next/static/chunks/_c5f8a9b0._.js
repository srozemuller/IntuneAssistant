...
"[project]/app/monitor/drift/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function DriftsOverviewPage() {
    ...
    const { monitors, drifts, setMonitors, setDrifts, hasData, updateLastFetchTime } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$contexts$2f$MonitorContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMonitorContext"])();
    ...
    const [selectedMonitors, setSelectedMonitors] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const fetchData = async ()=>{
        ...
        try {
            var _monitorsResponse_data, _driftsResponse_data;
    ...
    const filteredDrifts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DriftsOverviewPage.useMemo[filteredDrifts]": ()=>{
            let filtered = drifts;
            if (selectedMonitors.length > 0) {
                filtered = filtered.filter({
                    "DriftsOverviewPage.useMemo[filteredDrifts]": (d)=>selectedMonitors.includes(d.monitorId)
                }["DriftsOverviewPage.useMemo[filteredDrifts]"]);
            }
            if (statusFilter.length > 0) {
                filtered = filtered.filter({
                    "DriftsOverviewPage.useMemo[filteredDrifts]": (d)=>statusFilter.includes(d.status)
                }["DriftsOverviewPage.useMemo[filteredDrifts]"]);
            }
            if (resourceTypeFilter.length > 0) {
                filtered = filtered.filter({
                    "DriftsOverviewPage.useMemo[filteredDrifts]": (d)=>resourceTypeFilter.includes(d.resourceType)
                }["DriftsOverviewPage.useMemo[filteredDrifts]"]);
            }
            return filtered;
        }
    ...
    const monitorOptions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DriftsOverviewPage.useMemo[monitorOptions]": ()=>{
            return monitors.map({
                "DriftsOverviewPage.useMemo[monitorOptions]": (m)=>({
                        label: m.displayName,
                        value: m.id
                    })
            }["DriftsOverviewPage.useMemo[monitorOptions]"]);
    ...
    const statusOptions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DriftsOverviewPage.useMemo[statusOptions]": ()=>[
                {
                    label: 'Active',
                    value: 'active'
                },
    ...
    const resourceTypeOptions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DriftsOverviewPage.useMemo[resourceTypeOptions]": ()=>{
            const types = new Set(drifts.map({
                "DriftsOverviewPage.useMemo[resourceTypeOptions]": (d)=>d.resourceType
            }["DriftsOverviewPage.useMemo[resourceTypeOptions]"]));
            return Array.from(types).map({
                "DriftsOverviewPage.useMemo[resourceTypeOptions]": (type)=>({
                        label: type,
                        value: type
                    })
            }["DriftsOverviewPage.useMemo[resourceTypeOptions]"]);
    ...
    const getMonitorName = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DriftsOverviewPage.useMemo[getMonitorName]": ()=>{
            const monitorMap = new Map(monitors.map({
                "DriftsOverviewPage.useMemo[getMonitorName]": (m)=>[
                        m.id,
                        m.displayName
                    ]
            }["DriftsOverviewPage.useMemo[getMonitorName]"]));
            return ({
                "DriftsOverviewPage.useMemo[getMonitorName]": (monitorId)=>monitorMap.get(monitorId) || 'Unknown Monitor'
            })["DriftsOverviewPage.useMemo[getMonitorName]"];
        }
    }["DriftsOverviewPage.useMemo[getMonitorName]"], [
        monitors
    ...
    const stats = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DriftsOverviewPage.useMemo[stats]": ()=>({
                totalDrifts: drifts.length,
                activeDrifts: drifts.filter({
                    "DriftsOverviewPage.useMemo[stats]": (d)=>d.status === 'active'
                }["DriftsOverviewPage.useMemo[stats]"]).length,
                fixedDrifts: drifts.filter({
                    "DriftsOverviewPage.useMemo[stats]": (d)=>d.status === 'fixed'
                }["DriftsOverviewPage.useMemo[stats]"]).length,
                totalMonitors: monitors.length,
                monitorsWithDrifts: new Set(drifts.map({
                    "DriftsOverviewPage.useMemo[stats]": (d)=>d.monitorId
                }["DriftsOverviewPage.useMemo[stats]"])).size,
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                                ...
                                                children: [
                                                    ...
                                                    isExpanded && drift.driftedProperties.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(DriftsOverviewPage, "v/tWWGVqYURu8sMt+Q6lZ4gRbbA=", false, function() {
    return [
...
_c = DriftsOverviewPage;
var _c;
__turbopack_context__.k.register(_c, "DriftsOverviewPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_c5f8a9b0._.js.map