...
"[project]/app/audit-events/search/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AuditSearchPage() {
    ...
    const handleSearch = async ()=>{
        ...
        try {
            var _response_data;
            const response = await request(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AUDIT_EVENT_FILTER_ENDPOINT"], {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
            ...
            if (response === null || response === void 0 ? void 0 : (_response_data = response.data) === null || _response_data === void 0 ? void 0 : _response_data.items) {
    ...
    const handleDatePreset = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuditSearchPage.useCallback[handleDatePreset]": (hours)=>{
            const to = new Date();
            const from = new Date();
    ...
    }["AuditSearchPage.useCallback[handleDatePreset]"], []);
    const clearFilters = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuditSearchPage.useCallback[clearFilters]": ()=>{
    ...
    const savePreset = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuditSearchPage.useCallback[savePreset]": ()=>{
    ...
    const loadPreset = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuditSearchPage.useCallback[loadPreset]": (preset)=>{
    ...
    }["AuditSearchPage.useCallback[loadPreset]"], []);
    const deletePreset = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuditSearchPage.useCallback[deletePreset]": (id)=>{
            const updated = savedPresets.filter({
                "AuditSearchPage.useCallback[deletePreset].updated": (p)=>p.id !== id
            }["AuditSearchPage.useCallback[deletePreset].updated"]);
            setSavedPresets(updated);
            localStorage.setItem('auditFilterPresets', JSON.stringify(updated));
        }
    }["AuditSearchPage.useCallback[deletePreset]"], [
        savedPresets
    ]);
    const exportToCSV = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuditSearchPage.useCallback[exportToCSV]": ()=>{
            const headers = [
                'Timestamp',
                'Activity',
                'Actor',
            ...
            const rows = events.map({
                "AuditSearchPage.useCallback[exportToCSV].rows": (e)=>[
                        e.activityDateTime,
                        e.activityType,
            ...
            }["AuditSearchPage.useCallback[exportToCSV].rows"]);
            const csv = [
                headers,
                ...rows
            ].map({
                "AuditSearchPage.useCallback[exportToCSV].csv": (row)=>row.join(',')
            }["AuditSearchPage.useCallback[exportToCSV].csv"]).join('\n');
            const blob = new Blob([
                csv
            ], {
                type: 'text/csv'
            ...
            a.href = url;
            a.download = "audit-events-".concat(new Date().toISOString(), ".csv");
            a.click();
        }
    }["AuditSearchPage.useCallback[exportToCSV]"], [
        events
    ]);
    const exportToJSON = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuditSearchPage.useCallback[exportToJSON]": ()=>{
            ...
            const a = document.createElement('a');
            a.href = url;
            a.download = "audit-events-".concat(new Date().toISOString(), ".json");
            a.click();
        }
    }["AuditSearchPage.useCallback[exportToJSON]"], [
        events
    ...
    const toggleRowExpansion = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuditSearchPage.useCallback[toggleRowExpansion]": (id)=>{
            setExpandedRows({
                "AuditSearchPage.useCallback[toggleRowExpansion]": (prev)=>{
            ...
            }["AuditSearchPage.useCallback[toggleRowExpansion]"]);
        }
    }["AuditSearchPage.useCallback[toggleRowExpansion]"], []);
    const getResultBadge = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuditSearchPage.useCallback[getResultBadge]": (result)=>{
            switch(result){
                case 'Success':
    ...
    }["AuditSearchPage.useCallback[getResultBadge]"], []);
    const activeFiltersCount = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AuditSearchPage.useMemo[activeFiltersCount]": ()=>{
            return [
                ...
                "AuditSearchPage.useMemo[activeFiltersCount]": (a, b)=>a + b
            }["AuditSearchPage.useMemo[activeFiltersCount]"], 0);
        }
    }["AuditSearchPage.useMemo[activeFiltersCount]"], [
        selectedCategories,
        selectedActivities,
    ...
    const totalPages = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AuditSearchPage.useMemo[totalPages]": ()=>Math.ceil(totalCount / pageSize)
    }["AuditSearchPage.useMemo[totalPages]"], [
        totalCount,
        pageSize
    ]);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$select$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Select"], {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$select$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SelectContent"], {
                                                        children: metadata === null || metadata === void 0 ? void 0 : metadata.categories.map((cat)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$select$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SelectItem"], {
                                                                value: cat,
                                                                children: cat
                                                            }, cat, false, {
                                                                fileName: "[project]/app/audit-events/search/page.tsx",
                                                    ...
                                                    children: [
                                                        ...
                                                        event.resources && event.resources.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            children: [
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    className: "space-y-2",
                                                                    children: event.resources.map((resource, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                            ...
                                                                            children: [
                                                                                ...
                                                                                resource.modifiedProperties && resource.modifiedProperties.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                                    ...
                                                                                    children: resource.modifiedProperties.map((prop, pidx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                                            className: "text-xs",
                                                                                            children: [
                                                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
_c = AuditSearchPage;
var _c;
__turbopack_context__.k.register(_c, "AuditSearchPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_8c3da2da._.js.map