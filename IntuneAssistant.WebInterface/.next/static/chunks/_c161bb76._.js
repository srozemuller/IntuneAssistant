...
function AuditDashboardPage() {
    ...
    const { statistics, recentEvents, loading, loadingMore, error, hasMore, fetchData, loadMore } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$contexts$2f$AuditEventsContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuditEvents"])();
    ...
    const [tableItemsPerPage, setTableItemsPerPage] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(50);
    const [tablePage, setTablePage] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(1);
    ...
    const activitiesByCategory = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AuditDashboardPage.useMemo[activitiesByCategory]": ()=>{
            if (!(statistics === null || statistics === void 0 ? void 0 : statistics.eventsByCategory) || !(statistics === null || statistics === void 0 ? void 0 : statistics.topActivities)) return {};
            ...
            Object.entries(statistics.eventsByCategory).forEach({
                "AuditDashboardPage.useMemo[activitiesByCategory]": (param)=>{
                    let [category, totalCount] = param;
                    // Find all activities for this category
                    const categoryActivities = statistics.topActivities.filter({
                        "AuditDashboardPage.useMemo[activitiesByCategory].categoryActivities": (item)=>item.category === category
                    }["AuditDashboardPage.useMemo[activitiesByCategory].categoryActivities"]).map({
                        "AuditDashboardPage.useMemo[activitiesByCategory].categoryActivities": (item)=>({
                                activity: item.activity,
                                count: item.count
                            })
                    }["AuditDashboardPage.useMemo[activitiesByCategory].categoryActivities"]).sort({
                        "AuditDashboardPage.useMemo[activitiesByCategory].categoryActivities": (a, b)=>b.count - a.count
                    }["AuditDashboardPage.useMemo[activitiesByCategory].categoryActivities"]);
                    result[category] = {
                        totalCount,
            ...
            return Object.entries(result).sort({
                "AuditDashboardPage.useMemo[activitiesByCategory]": (a, b)=>b[1].totalCount - a[1].totalCount
            }["AuditDashboardPage.useMemo[activitiesByCategory]"]).reduce({
                "AuditDashboardPage.useMemo[activitiesByCategory]": (acc, param)=>{
        ...
        statistics === null || statistics === void 0 ? void 0 : statistics.eventsByCategory,
        statistics === null || statistics === void 0 ? void 0 : statistics.topActivities
    ]);
    const toggleCategory = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuditDashboardPage.useCallback[toggleCategory]": (category)=>{
            setExpandedCategories({
                "AuditDashboardPage.useCallback[toggleCategory]": (prev)=>{
            ...
            }["AuditDashboardPage.useCallback[toggleCategory]"]);
        }
    }["AuditDashboardPage.useCallback[toggleCategory]"], []);
    // Memoize most active users to prevent recalculation
    const mostActiveUsers = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AuditDashboardPage.useMemo[mostActiveUsers]": ()=>{
            return (statistics === null || statistics === void 0 ? void 0 : statistics.mostActiveUsers) || [];
        }
    }["AuditDashboardPage.useMemo[mostActiveUsers]"], [
        statistics === null || statistics === void 0 ? void 0 : statistics.mostActiveUsers
    ]);
    ...
    const filteredEvents = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AuditDashboardPage.useMemo[filteredEvents]": ()=>{
            let filtered = recentEvents;
            if (selectedCategory) {
                filtered = filtered.filter({
                    "AuditDashboardPage.useMemo[filteredEvents]": (event)=>event.category === selectedCategory
                }["AuditDashboardPage.useMemo[filteredEvents]"]);
            }
            if (selectedActivity) {
                // Filter by category only (from Top Activities click)
                filtered = filtered.filter({
                    "AuditDashboardPage.useMemo[filteredEvents]": (event)=>event.category === selectedActivity.category
                }["AuditDashboardPage.useMemo[filteredEvents]"]);
            }
            return filtered;
        }
    ...
    const eventColumns = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AuditDashboardPage.useMemo[eventColumns]": ()=>[
                {
                    key: 'activityDateTime',
                    label: 'Time',
                    width: 180,
                    render: {
                        "AuditDashboardPage.useMemo[eventColumns]": (value)=>{
                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "flex items-center gap-2",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$clock$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Clock$3e$__["Clock"], {
                ...
                },
                {
                    ...
                    width: 280,
                    render: {
                        "AuditDashboardPage.useMemo[eventColumns]": (value, row)=>{
                            const event = row;
                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                },
                {
                    ...
                    render: {
                        "AuditDashboardPage.useMemo[eventColumns]": (value)=>{
                            ...
                            return upn && upn !== 'undefined' ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "flex items-center gap-2",
                                children: [
                ...
                },
                {
                    ...
                    width: 140,
                    render: {
                        "AuditDashboardPage.useMemo[eventColumns]": (value)=>getResultBadge(String(value))
                    }["AuditDashboardPage.useMemo[eventColumns]"]
                },
                {
                    key: 'id',
                    ...
                    render: {
                        "AuditDashboardPage.useMemo[eventColumns]": (value)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                ...
                                variant: "ghost",
                                onClick: {
                                    "AuditDashboardPage.useMemo[eventColumns]": (e)=>{
                                        e.stopPropagation();
                                        router.push("/audit-events/".concat(String(value)));
                                    }
                                }["AuditDashboardPage.useMemo[eventColumns]"],
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$eye$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Eye$3e$__["Eye"], {
                                    className: "h-4 w-4"
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardDescription"], {
                                                    children: selectedCategory ? "Filtered by: ".concat(selectedCategory) : 'Click on a category to filter'
                                                }, void 0, false, {
                                                    fileName: "[project]/app/audit-events/page.tsx",
                                                    lineNumber: 569,
                                                    columnNumber: 33
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "space-y-4",
                                    children: mostActiveUsers.slice(0, 5).map((user, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardDescription"], {
                                                    children: selectedActivity ? "Filtered by: ".concat(selectedActivity.category) : 'Click category to filter events'
                                                }, void 0, false, {
                                                    fileName: "[project]/app/audit-events/page.tsx",
                                                    lineNumber: 669,
                                                    columnNumber: 33
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: Object.entries(activitiesByCategory).length > 0 ? Object.entries(activitiesByCategory).map((param, categoryIndex)=>{
                                        let [category, data] = param;
                                        const categoryData = data;
                                        const totalCount = categoryData.totalCount;
                                        const activities = categoryData.activities;
                                        const isExpanded = expandedCategories.has(category);
                                        const isSelected = (selectedActivity === null || selectedActivity === void 0 ? void 0 : selectedActivity.category) === category;
                                        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                    ...
                                                    className: "w-full flex items-center justify-between p-3 transition-colors ".concat(isSelected ? 'bg-blue-100 dark:bg-blue-900/30' : 'bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700'),
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            className: "flex items-center gap-3",
                                                            children: [
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    className: "w-8 h-8 rounded-full flex items-center justify-center text-white text-xs font-bold ".concat(categoryIndex === 0 ? 'bg-yellow-500' : categoryIndex === 1 ? 'bg-gray-400' : categoryIndex === 2 ? 'bg-orange-600' : 'bg-blue-500'),
                                                                    ...
                                                                    children: [
                                                                        ...
                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                            ...
                                                                            children: [
                                                                                totalCount,
                                                                                " events",
                                                                                activities.length > 0 ? " · ".concat(activities.length, " ").concat(activities.length === 1 ? 'activity' : 'activities') : ''
                                                                            ]
                                                                        }, void 0, true, {
                                                                            fileName: "[project]/app/audit-events/page.tsx",
                                                                            lineNumber: 771,
                                                ...
                                                isExpanded && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: activities.length > 0 ? activities.map((activity, actIndex)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardTitle"], {
                                            ...
                                            children: [
                                                ...
                                                (selectedCategory || selectedActivity) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$badge$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Badge"], {
                                                    ...
                                                    className: "ml-2",
                                                    children: [
                                                        selectedCategory || (selectedActivity === null || selectedActivity === void 0 ? void 0 : selectedActivity.category),
                                                        " - ",
                        ...
                        children: filteredEvents.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$DataTable$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DataTable"], {
                                    ...
                                    onRowClick: (row)=>{
                                        const event = row;
                                        router.push("/audit-events/".concat(event.id));
                                    }
                                }, void 0, false, {
                                    fileName: "[project]/app/audit-events/page.tsx",
                                    lineNumber: 862,
...
_s(AuditDashboardPage, "FkUlCgZnCf8FOyMJiUYe18gP/Gg=", false, function() {
    return [
...
//# sourceMappingURL=_c161bb76._.js.map