...
- **Bulk operations** that work across multiple tenants
...
1. **Main tenant** serves as your primary management hub
...
- **Audit trail** - Complete logging of all cross-tenant activities
...
2. **Request appropriate roles** for Intune management
3. **Wait for customer approval** of the delegated privileges
4. **Add tenant** to Intune Assistant using the tenant switcher
...
- [Partner Center GDAP Management](https://learn.microsoft.com/en-us/partner-center/customers/gdap-assign-azure-ad-roles)
- [Intune Multi-Tenant Best Practices](https://learn.microsoft.com/en-us/intune/fundamentals/multi-tenant-best-practices)
