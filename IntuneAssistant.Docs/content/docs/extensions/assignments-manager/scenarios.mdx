...
PolicyName: Windows Security Baseline, GroupName: All Devices, AssignmentDirection: Include, AssignmentAction: Replace

PolicyName: iOS Compliance Policy, GroupName: All Users, AssignmentDirection: Include, AssignmentAction: Replace

PolicyName: Android App Protection, GroupName: All Users, AssignmentDirection: Include, AssignmentAction: Replace

PolicyName: BYOD Compliance, GroupName: All Users, AssignmentDirection: Include, AssignmentAction: Replace, Filter: Corporate Devices, Filter Type: Exclude

### Security Baseline Refresh (Enterprise)

PolicyName: Windows Security Baseline v3, GroupName: All Devices, AssignmentDirection: Include, AssignmentAction: Replace, Filter: Managed Devices, Filter Type: Include

PolicyName: Compliance Policy v2, GroupName: All Users, AssignmentDirection: Include, AssignmentAction: Replace

PolicyName: Legacy Baseline v1, GroupName: (empty), AssignmentDirection: (empty), AssignmentAction: NoAssignment

### Pilot to Production Migration

PolicyName: New Feature Policy, GroupName: All Users, AssignmentDirection: Include, AssignmentAction: Replace

PolicyName: Beta App Config, GroupName: Production Users, AssignmentDirection: Include, AssignmentAction: Replace

PolicyName: Test Policy, GroupName: (empty), AssignmentDirection: (empty), AssignmentAction: NoAssignment
