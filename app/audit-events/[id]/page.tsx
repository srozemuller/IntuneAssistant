    ...
    return (
        <div className="p-4 lg:p-8 space-y-6 w-full max-w-none">
            ...
            <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400">
                <Link href="/audit-events" className="hover:text-purple-500">Dashboard</Link>
                <ChevronRight className="h-4 w-4" />
                <Link href="/audit-events/search" className="hover:text-purple-500">Search</Link>
                <ChevronRight className="h-4 w-4" />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
                <Card className="lg:col-span-3 bg-gradient-to-br from-purple-50 to-violet-50 dark:from-purple-900/20 dark:to-violet-900/20 border-purple-200 dark:border-purple-800">
                    <CardContent className="pt-6">
                    ...
                    <Card className="bg-white/60 dark:bg-gray-900/30 backdrop-blur-lg border border-white/30 dark:border-white/10">
                        ...
                        <CardContent>
                            <div className="relative pl-8">
                                <div className="absolute left-2 top-0 bottom-0 w-0.5 bg-purple-200 dark:bg-purple-800"></div>

                                {/* Event Occurred */}
                                <div className="relative mb-8">
                                    <div className="absolute -left-6 w-4 h-4 rounded-full bg-purple-500 border-4 border-white dark:border-gray-900"></div>
                                    <div className="ml-4">
                    ...
                    <Card className="bg-white/60 dark:bg-gray-900/30 backdrop-blur-lg border border-white/30 dark:border-white/10">
                        ...
                        <CardContent>
                            ...
                            <div className="relative">
                                ...
                                <div className="absolute left-8 top-0 bottom-0 w-1 bg-gradient-to-b from-purple-500 via-violet-500 to-pink-500 opacity-20 rounded-full"></div>

                                <div className="space-y-6">
                                    {/* Current Event - Highlighted */}
                                    <div className="relative pl-20">
                                        <div className="absolute left-2 w-12 h-12 rounded-full bg-gradient-to-br from-purple-500 to-purple-600 flex items-center justify-center shadow-lg ring-4 ring-purple-500/20">
                                            <Activity className="h-6 w-6 text-white" />
                                        </div>
                                        <div className="bg-gradient-to-r from-purple-50 to-violet-50 dark:from-purple-900/40 dark:to-violet-900/40 border-2 border-purple-500 rounded-lg p-4 shadow-md">
                                            <div className="flex items-start justify-between">
                                                <div className="flex-1">
                                                    <div className="flex items-center gap-2 mb-2">
                                                        <Badge className="bg-purple-500">Current Event</Badge>
                                                        {getResultBadge(event.activityResult)}
                                                    </div>
                                                    ...
                                                    <div className={`bg-gradient-to-r ${bgColor} border border-gray-200 dark:border-gray-700 rounded-lg p-4 hover:shadow-lg transition-all cursor-pointer group`}>
                                                        <div className="flex items-start justify-between">
                                                            <div className="flex-1">
                                                                ...
                                                                <p className="font-semibold text-gray-900 dark:text-gray-100 mb-1 group-hover:text-purple-600 dark:group-hover:text-purple-400 transition-colors">
                                    ...
                                    {relatedEvents.map((relEvent) => {
                                        ...
                                        return (
                                            <Link key={relEvent.id} href={`/audit-events/${relEvent.id}`}>
                                                <div className="p-3 border border-gray-200 dark:border-gray-700 rounded-lg hover:shadow-md hover:border-purple-500 dark:hover:border-purple-500 transition-all cursor-pointer group relative">
                                                    ...
                                                    <div className="flex items-start gap-2">
                                                        ...
                                                        <div className="flex-1 min-w-0">
                                                            <p className="font-medium text-sm text-gray-900 dark:text-gray-100 group-hover:text-purple-600 dark:group-hover:text-purple-400 transition-colors truncate">
                                                                {relEvent.activityType || relEvent.displayName}
                                                            </p>
                                                        ...
                                                        <ChevronRight className="h-4 w-4 text-gray-400 group-hover:text-purple-500 transition-colors shrink-0" />
                                                    </div>
                                                </div>
                                            </Link>
                                        );
                    ...
                    <CardContent>
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                            {event.resources.map((resource, index) => {
                                ...
                                const borderColor = index % 2 === 0 ? 'border-l-purple-500' : 'border-l-violet-500';
