...
export default function AuditDashboardPage() {
    ...
    return (
        <div className="container mx-auto py-6 max-w-7xl space-y-6">
            {/* Hero */}
            <div className="relative overflow-hidden rounded-xl bg-gradient-to-br from-gray-900 via-purple-900 to-violet-900 p-8 text-white">
                <div className="relative z-10">
                    ...
                    <h1 className="text-4xl font-bold mb-4">Audit Events</h1>
                    <p className="text-xl text-white/80 max-w-2xl">
                        What changed in your tenant, by whom and when — real-time monitoring and insights into Intune audit activity.
                    </p>
                </div>
                <div className="absolute inset-0 opacity-10 pointer-events-none">
                    <div className="absolute top-20 right-20 w-64 h-64 rounded-full bg-gradient-to-br from-purple-400 to-violet-400 blur-3xl" />
                    <div className="absolute bottom-20 left-20 w-48 h-48 rounded-full bg-gradient-to-br from-violet-400 to-purple-400 blur-2xl" />
                </div>
            </div>
                            ...
                            <CardContent>
                                <ResponsiveContainer width="100%" height={300}>
                                    <BarChart data={timelineChartData}>
                                        ...
                                        <Bar dataKey="count" fill="#8b5cf6" fillOpacity={0.85} radius={[6, 6, 0, 0]} />
                                    </BarChart>
                                </ResponsiveContainer>
                            </CardContent>
                        </Card>
