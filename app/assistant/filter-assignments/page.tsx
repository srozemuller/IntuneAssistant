...
;
import { RefreshCw, Filter, Search, X, Group, Shield, ShieldCheck, ChevronDown, ChevronUp, XCircle, Blocks } from 'lucide-react';
...
export default function AssignmentsOverview() {
    ...
    }, [assignments, assignmentTypeFilter, statusFilter, platformFilter, filterTypeFilter, roleScopeTagFilter, filterNameFilter]);
                        ...
                        {filtersLoading ? (
                            <div className="text-center py-12">
                                ...
                                <p className="text-gray-600 dark:text-gray-300">
                                    Fetching assignment filters from your Intune environment...
                                </p>
                            </div>
                        ) : (
                            <div className="text-center">
                                <Button onClick={() => { fetchFilters(); fetchRoleScopeTags(); }} className="inline-flex items-center gap-2">
