...
;
import { RefreshCw, Filter, Database, Search, X, Users, Group, ExternalLink, Shield, ShieldCheck, ChevronDown, ChevronUp, XCircle, Blocks } from 'lucide-react';
import {ASSIGNMENTS_ENDPOINT, GROUPS_ENDPOINT, ASSIGNMENTS_FILTERS_ENDPOINT, ROLE_SCOPETAGS_ENDPOINT, ITEMS_PER_PAGE} from '@/lib/constants';
;
...
export default function AssignmentsOverview() {
    ...
    useEffect(() => {
        setCurrentPage(1);
    }, [assignmentTypeFilter, statusFilter, platformFilter, searchQuery, resourceTypeFilter, filterTypeFilter, roleScopeTagFilter, filterNameFilter]);
    ...
    const searchGroup = async () => {
        ...
        try {
            ...
            const groupData = envelope.data as GroupDetails | GroupDetails[];
    ...
    const filteredAssignments = useMemo(() => {
        ...
        return filtered;
    }, [assignments, resourceTypeFilter, assignmentTypeFilter, statusFilter, platformFilter, filterTypeFilter, roleScopeTagFilter, filterNameFilter]);
    ...
    const uniqueRoleScopeTags = useMemo((): Option[] => {
    ...
    }, [assignments, roleScopeTags]);

    const uniqueFilterNames = useMemo((): Option[] => {
                        ...
                        {isFiltersExpanded && (
                            <CardContent className="space-y-4">
                                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                    ...
                                    <div className="space-y-2">
                                        <label className="text-sm font-medium">Role Scope Tags</label>
                                        <MultiSelect
                                            options={uniqueRoleScopeTags}
